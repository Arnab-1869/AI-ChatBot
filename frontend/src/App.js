  ...
  return (
    <div style={{
      ...
      <div style={{ 
        ...
        margin: '0 auto', 
        padding: '10px', 
        background: 'linear-gradient(90deg, #039be5 0%, #00b8d4 25%, #26c6da 50%, #4dd0e1 75%, #80deea 100%)', 
        borderRadius: '16px', 
        boxShadow: '0 8px 32px 0 rgba(31, 38, 135, 0.25), 0 1.5px 6px 0 rgba(0,0,0,0.10), 0 0.5px 1.5px 0 rgba(0,0,0,0.08)',
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', gap: '10px' }}>
          ...
          onMouseOut={(e) => e.target.style.backgroundColor = '#4caf50'}>Send</button>
        </form>
      </div>
    </div>
  );
